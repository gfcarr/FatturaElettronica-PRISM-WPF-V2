...
<xsl:stylesheet version="1.1"
	...
	xmlns:b="http://www.fatturapa.gov.it/sdi/fatturapa/v1.0"
	xmlns:c="http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.2"
  ...
  <xsl:template name="RappresentanteFiscale">
    <xsl:param name="Info" />
    ...
    <ul>
      <xsl:if test="$Info/IdFiscaleIVA">
        <li>
          Identificativo fiscale ai fini IVA:
          <span>
            <xsl:value-of select="$Info/IdFiscaleIVA/IdPaese" />
            <xsl:value-of select="$Info/IdFiscaleIVA/IdCodice" />
          </span>
        </li>
      </xsl:if>

      <xsl:if test="$Info/Denominazione">
        <li>
          Denominazione:
          <span>
            <xsl:value-of select="$Info/Denominazione" />
          </span>
        </li>
      </xsl:if>
      <xsl:if test="$Info/Nome">
        <li>
          Nome:
          <span>
      ...
      <xsl:if test="$Info/Cognome">
        <li>
          Cognome:
          <span>
            <xsl:value-of select="$Info/Cognome" />
          </span>
        </li>
      </xsl:if>
  ...
  <xsl:template name="SedeStabile">
    ...
    <ul>
      ...
      <xsl:if test="$Info/Indirizzo">
        <li>
          Indirizzo:
          <span>
            <xsl:value-of select="$Info/Indirizzo" />
          </span>
        </li>
      </xsl:if>
      <xsl:if test="$Info/NumeroCivico">
        <li>
          Numero civico:
          <span>
            <xsl:value-of select="$Info/NumeroCivico" />
          </span>
        </li>
      </xsl:if>
      <xsl:if test="$Info/CAP">
        <li>
          CAP:
          <span>
            <xsl:value-of select="$Info/CAP" />
          </span>
        </li>
      </xsl:if>
      <xsl:if test="$Info/Comune">
        <li>
          Comune:
          <span>
            <xsl:value-of select="$Info/Comune" />
          </span>
        </li>
      </xsl:if>
      <xsl:if test="$Info/Provincia">
        <li>
          Provincia:
          <span>
            <xsl:value-of select="$Info/Provincia" />
          </span>
        </li>
      </xsl:if>
      <xsl:if test="$Info/Nazione">
        <li>
          Nazione:
          <span>
            <xsl:value-of select="$Info/Nazione" />
          </span>
        </li>
      </xsl:if>
    </ul>
    ...
    <xsl:if test="$TipoFattura">
      ...
      <div id="fattura-elettronica">
        ...
        <xsl:if test="$TipoFattura/FatturaElettronicaHeader">
          <div class="page">
            <div class="versione">
              Versione <xsl:value-of select="$TipoFattura/@versione"/>
            </div>
            ...
            <xsl:for-each select="$TipoFattura/FatturaElettronicaHeader/CedentePrestatore">
              <div id="cedente">
                  ...
                  <ul>
                    ...
                    <xsl:if test="RegimeFiscale">
                      <xsl:call-template name="RegimeFiscale">
                        <xsl:with-param name="RF" select="RegimeFiscale" />
                      </xsl:call-template>
                    </xsl:if>

                  </ul>
                </xsl:for-each>
                <!-- Fine Dati Anagrafici FPA\FPR -->

                <!-- Dati Anagrafici per FSM10 o FPRS-->
                <xsl:if test="IdFiscaleIVA or CodiceFiscale or Denominazione or Nome or Cognome or RegimeFiscale">
                ...
                <!-- Fine Dati Anagrafici per FSM10 o FPRS-->

                <!--SEDE-->
                <xsl:if test="Sede">
                  <xsl:call-template name="SedeStabile">
                    <xsl:with-param name="Info" select="Sede" />
                    <xsl:with-param name="Title" select="'Dati della sede'" />
                  </xsl:call-template>
                </xsl:if>
                ...
                <xsl:if test="StabileOrganizzazione">
                  <xsl:call-template name="SedeStabile">
                    <xsl:with-param name="Title" select="'Dati della stabile organizzazione'"/>
                    <xsl:with-param name="Info" select="StabileOrganizzazione" />
                  </xsl:call-template>
                </xsl:if>

                <!--Rappresentante fiscale solo FPRS-->
                <xsl:if test="RappresentanteFiscale">
                  <xsl:call-template name="RappresentanteFiscale">
                    <xsl:with-param name="Title" select="'Rappresentante Fiscale'"/>
                    <xsl:with-param name="Info" select="RappresentanteFiscale" />
                  </xsl:call-template>
                </xsl:if>
                ...
                <!--Contatti solo FPA o FPR-->
                <xsl:for-each select="Contatti">
                ...
                <!--Riferimento Amministrazione solo FPA o FPR-->
            ...
            <!--INIZIO DATI RAPPRESENTANTE FISCALE solo FPA e FPR -->
            <xsl:if test="$TipoFattura/FatturaElettronicaHeader/RappresentanteFiscale">
              <div id="rappresentante-fiscale">
                <h3>Dati del rappresentante fiscale del cedente / prestatore</h3>
                <xsl:if test="$TipoFattura/FatturaElettronicaHeader/RappresentanteFiscale/DatiAnagrafici">
                  <h4>Dati anagrafici</h4>
            ...
            <xsl:for-each select="$TipoFattura/FatturaElettronicaHeader/CessionarioCommittente">
              <div id="cessionario">
                ...
                <!-- AltriDatiIndentificativi per FPRS -->
                <xsl:for-each select="AltriDatiIdentificativi">
                  ...
                  <xsl:if test="StabileOrganizzazione">
                    <xsl:call-template name="SedeStabile">
                      <xsl:with-param name="Title" select="'Stabile organizzazione del cessionario / committente'"/>
                      <xsl:with-param name="Info" select="StabileOrganizzazione" />
                    </xsl:call-template>
                  </xsl:if>
                  ...
                  <xsl:if test="RappresentanteFiscale">
                    <xsl:call-template name="RappresentanteFiscale">
                      <xsl:with-param name="Title" select="'Dati del rappresentante fiscale del cessionario / committente'"/>
                      <xsl:with-param name="Info" select="RappresentanteFiscale" />
                    </xsl:call-template>
                  </xsl:if>
            ...
            <!--INIZIO DATI TERZO INTERMEDIARIO SOGGETTO EMITTENTE per FPA e FPR-->
        ...
        <xsl:variable name="TOTALBODY">
          <xsl:value-of select="count($TipoFattura/FatturaElettronicaBody)" />
        </xsl:variable>
          ...
          <div class="page">
            ...
            <xsl:if test="DatiGenerali">
              ...
              <div id="dati-generali">
                ...
                <xsl:if test="DatiGenerali/DatiGeneraliDocumento">
                  ...
                  <div id="dati-generali-documento">
                    ...
                    <ul>
                      ...
                      <!-- Bollo Virtuale per la fattura FPRS   -->
                      ...
                      <!--Fine bollo virtuale fattura FPRS-->
                    ...
                    <xsl:if test="DatiGenerali/DatiGeneraliDocumento/DatiBollo">
                      <div id="dati-bollo">
                        <xsl:for-each select="DatiGenerali/DatiGeneraliDocumento/DatiBollo">
                          <h4>Bollo</h4>
                          <ul>
                            <!-- NumeroBollo solo in versione 1.0 -->
                              ...
                              <li>
                                ...
                                <xsl:choose>
                                  ...
                                  <xsl:when test="$NT='N7'">
                                    ...
                                    ex art. 7-octies lett. a, b, art. 74-sexies DPR 633/72)
                                  </xsl:when>
                                  <xsl:when test="$NT=''">
                                  </xsl:when>
                                  <xsl:otherwise>
                ...
                <!--INIZIO NORMA RIFERIMENTO solo versione 1.0-->
                ...
                <!--INIZIO DATI FATTURA RETTIFICATA per FPRS-->
                <xsl:if test="DatiGenerali/DatiFatturaRettificata">

                  <div id="dati-fattura-rettuficata">
                    <h3>Dati Fattura Rettificata</h3>

                    <ul>
                      <xsl:if test="DatiGenerali/DatiFatturaRettificata/NumeroFR">
                        <li>
                      ...
                      <xsl:if test="DatiGenerali/DatiFatturaRettificata/DataFR">
                        <li>
                          Data fattura rettificata:
                          <span>
                            <xsl:value-of select="DatiGenerali/DatiFatturaRettificata/DataFR" />
                          </span>
                          <xsl:call-template name="FormatDate">
                      ...
                      <xsl:if test="DatiGenerali/DatiFatturaRettificata/ElementiRettificati">
                        <li>
                          Elementi oggetto di rettifica:
                          <span>
                ...
                <!--FINE DATI FATTURA RETTIFICATA per FPRS-->
            ...
            <xsl:choose>
              <xsl:when test="$TipoFattura/FatturaElettronicaHeader/DatiTrasmissione/FormatoTrasmissione='FSM10'">
                <!--INIZIO DATI BENI E SERVIZI FPRS-->
                <xsl:if test="DatiBeniServizi">
                  <div id="dati-beni-servizi">

                    <!--INIZIO DATI DI DETTAGLIO DELLE LINEE-->
                    <div id="righe">
                      <h3>Dati relativi Beni Sevizi</h3>
                ...
                <!--FINE DATI BENI E SERVIZI FPRS-->
              </xsl:when>
              <xsl:otherwise>
                <!--INIZIO DATI BENI E SERVIZI FPA e FPR-->
                <xsl:if test="DatiBeniServizi">
